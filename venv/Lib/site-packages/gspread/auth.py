...
DEFAULT_CREDENTIALS_FILENAME = DEFAULT_CONFIG_DIR / "credentials.toml"
...
def oauth(
    ...
    **will not work** in this case::
    ...
    default, you may provide a path to that file like so::
        ...
        gc = gspread.oauth(
            credentials_filename='/alternative/path/credentials.toml',
    ...
    :param str credentials_filename: Filepath (including name) pointing to a
        ...
        Defaults to DEFAULT_CREDENTIALS_FILENAME:
            ...
            * `%APPDATA%\gspread\credentials.toml` on Windows
            * `~/.config/gspread/credentials.toml` everywhere else
